  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
        <div className="bg-white shadow-md rounded-lg p-6 w-[70%] h-[60%] md:h-[80vh] text-center">
          <input
            type="file"
            ref={fileRef}
            hidden
          ...
          <div className="flex flex-col gap-2 w-full">
            <button
              ...
              className=" w-full md:w-1/4 mx-auto px-4 py-2 text-white bg-primary-600 hover:bg-primary-700 rounded disabled:opacity-60"
              disabled={uploading}
            >
            ...
            <button
              ...
              className="w-full md:w-1/4 mx-auto px-4 py-2 text-white bg-red-500 hover:bg-red-600 rounded"
            >
              Logout
            </button>
          </div>
